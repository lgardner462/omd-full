host_groups = [
  ( 'neuro-printer', ['neuro-printer'], ALL_HOSTS ),   
  ( 'snmp', ['snmp'], ALL_HOSTS ), 
] + host_groups
...
extra_service_conf['_ec_sl'] = [
  ( 0, ['neuro-printer'] , ALL_HOSTS, ALL_SERVICES),
] + extra_service_conf['_ec_sl']
...
extra_host_conf['check_interval'] = [
  ( 5, ['neuro-printer', ], ALL_HOSTS ),
] + extra_host_conf['check_interval']


host_contactgroups = [
  ( 'neuro-admins', ['neuro-printer'], ALL_HOSTS),
] + host_contactgroups
...
extra_service_conf['check_interval'] = [
  ( 5, ['neuro-printer', ], ALL_HOSTS, ALL_SERVICES ),
] + extra_service_conf['check_interval']
...
extra_service_conf['notification_period'] = [
  ( 'allday', ['neuro-printer', ], ALL_HOSTS, ALL_SERVICES ),
] + extra_service_conf['notification_period']
...
extra_service_conf['notification_interval'] = [
  ( 60, ['neuro-printer', ], ALL_HOSTS, ALL_SERVICES ),
] + extra_service_conf['notification_interval']


service_contactgroups = [
  ( 'neuro-admins', ['neuro-printer', ], ALL_HOSTS, ALL_SERVICES ),
] + service_contactgroups


service_groups = [
  ( 'neuro-printer', ['neuro-printer', ], ALL_HOSTS, ALL_SERVICES ),
] + service_groups
...
extra_host_conf['notification_period'] = [
  ( 'allday', ['neuro-printer', ], ALL_HOSTS ),
] + extra_host_conf['notification_period']
 ...
 {'allow_disable': True,
  ...
  'notify_plugin': ('asciimail',
                    {'common_body': u'Host:     $HOSTNAME$\n',
                     'from': 'neuro-noc@techsquare.com',
                     'host_body': u'Event:    $EVENT_TXT$\nOutput:   $HOSTOUTPUT$\nPerfdata: $HOSTPERFDATA$\n$LONGHOSTOUTPUT$\n',
                     'host_subject': u'neuro scheduled downtime: $HOSTNAME$ - $EVENT_TXT$',
                     'reply_to': 'neuro-noc@techsquare.com',
                     'service_body': u'Service:  $SERVICEDESC$\nEvent:    $EVENT_TXT$\nOutput:   $SERVICEOUTPUT$\nPerfdata: $SERVICEPERFDATA$\n$LONGSERVICEOUTPUT$\n'})},
 {'allow_disable': True,
  ...
  'notify_plugin': ('asciimail',
                    {'common_body': u'Host:     $HOSTNAME$\n',
                     'from': 'neuro-noc@techsquare.com',
                     'host_body': u'Event:    $EVENT_TXT$\nOutput:   $HOSTOUTPUT$\nPerfdata: $HOSTPERFDATA$\n$LONGHOSTOUTPUT$\n',
                     'host_subject': u'neuro FLAPPING alert: $HOSTNAME$ - $EVENT_TXT$',
                     'reply_to': 'neuro-noc@techsquare.com',
                     'service_body': u'Service:  $SERVICEDESC$\nEvent:    $EVENT_TXT$\nOutput:   $SERVICEOUTPUT$\nPerfdata: $SERVICEPERFDATA$\n$LONGSERVICEOUTPUT$\n'})},
 {'allow_disable': True,
  ...
  'notify_plugin': ('asciimail',
                    {'common_body': u'Host:     $HOSTNAME$\n',
                     'from': 'neuro-noc@techsquare.com',
                     'host_body': u'Event:    $EVENT_TXT$\nOutput:   $HOSTOUTPUT$\nPerfdata: $HOSTPERFDATA$\n$LONGHOSTOUTPUT$\n',
                     'host_subject': u'neuro RECOVERY alert: $HOSTNAME$ - $EVENT_TXT$',
                     'reply_to': 'neuro-noc@techsquare.com',
                     'service_body': u'Service:  $SERVICEDESC$\nEvent:    $EVENT_TXT$\nOutput:   $SERVICEOUTPUT$\nPerfdata: $SERVICEPERFDATA$\n$LONGSERVICEOUTPUT$\n'})},
 {'allow_disable': True,
  ...
  'notify_plugin': ('asciimail',
                    {'common_body': u'Host:     $HOSTNAME$\n',
                     'from': 'neuro-noc@techsquare.com',
                     'host_body': u'Event:    $EVENT_TXT$\nOutput:   $HOSTOUTPUT$\nPerfdata: $HOSTPERFDATA$\n$LONGHOSTOUTPUT$\n',
                     'host_subject': u'neuro PROBLEM alert: $HOSTNAME$ - $EVENT_TXT$',
                     'reply_to': 'neuro-noc@techsquare.com',
                     'service_body': u'Service:  $SERVICEDESC$\nEvent:    $EVENT_TXT$\nOutput:   $SERVICEOUTPUT$\nPerfdata: $SERVICEPERFDATA$\n$LONGSERVICEOUTPUT$\n'})},
 {'allow_disable': True,
